...
mHTDMA2, gplotHTDMA2 =
    push_plot_to_gui!(plotHTDMA2, gui["HTDMAAerosolSizeDistribution2"], wnd)
...
mHTDMA3, gplotHTDMA3 =
    push_plot_to_gui!(plotHTDMA3, gui["HTDMAAerosolSizeDistribution3"], wnd)
...
mHTDMA4, gplotHTDMA4 =
    push_plot_to_gui!(plotHTDMA4, gui["HTDMAAerosolSizeDistribution4"], wnd)
...
mHTDMA5, gplotHTDMA5 =
    push_plot_to_gui!(plotHTDMA5, gui["HTDMAAerosolSizeDistribution5"], wnd)
...
mHTDMA6, gplotHTDMA6 =
    push_plot_to_gui!(plotHTDMA6, gui["HTDMAAerosolSizeDistribution6"], wnd)
